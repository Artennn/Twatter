...
export const LoginValidation = z
    .object({
        ...
        password2: z.string().min(5, "Password is too short"),
    })
            ...
            <Box component="form" noValidate onSubmit={handleSubmit(onSubmit)}>
                <FormProvider {...formMethodes}>
                    <Stack direction="column" height="100%" spacing={3} pl={10} pr={10}>
                        ...
                        >
                            <SvgIcon version="1.1" viewBox="0 0 48 48" sx={{ height: 24, width: 24, mr: 1 }}>
                        ...
                        >
                            <SvgIcon version="1.1" viewBox="0 0 100 100" sx={{ height: 24, width: 24, mr: 1 }}>
                        ...
                        <Stack direction="row">
                            ...
                            <Typography ml={1} mr={1} > or </Typography>
                            <Box height="1px" bgcolor="rgb(51, 54, 57)" flex={1} mt="auto" mb="auto" />
                        </Stack>
